  ...
  return (
    <Container class1="store-wrapper home-wrapper-2">
      <div className="row pt-2">
        <div className="col-6 chatbot-title">
          Multi-turn Search
        </div>
        <div className="col-6 chatbot-title">
          Reference Results
      ...
      <div className="row">
        <div className="col-6">
          ...
          <div className="chatbot-search-section py-3">
            <ChatSearch onSearch={continueConvo} isLoading={isLoading} resetOnClick={resetOnClick}/>
          </div>

        {/* ConversationHistory */}
          {!isFollowup && 
            <ConversationHistory engine={engine} isLoading={isLoading} onConversationClick={onConversationClick}/>}
