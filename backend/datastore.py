...
def list_documents(PROJECT_ID: str, location: str, engine_id: str, rate_limit: int = 1):
  ...
  request = discoveryengine_v1beta.ListDocumentsRequest(
      parent=f'projects/{PROJECT_ID}/locations/{location}/collections/default_collection/dataStores/{engine_id}/branches/0',
      page_size=1000
  )
...
def list_details(docs):
  ...
  for doc in docs:
    ...
    result = {
      ...
      "filter_summary_brief": data.get('structData', {}).get('summary_brief',{}),
