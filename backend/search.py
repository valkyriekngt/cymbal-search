...
def search(
    ...
    safety_attributes_categories = [cat for cat in safety_attributes.categories]
    ...
    for result in response.results:
        ...
        formatted_result['filter_summary_brief'] = data.get('structData', {}).get('summary_brief',{})
        formatted_result['filter_summary_comprehensive'] = data.get('structData', {}).get('summary_comprehensive',{})
        ...
        formatted_result['extractive_segments_pageNumber'] = [d.get('pageNumber') for d in data.get('derivedStructData', {}).get('extractive_segments', []) if d.get('pageNumber') is not None]
